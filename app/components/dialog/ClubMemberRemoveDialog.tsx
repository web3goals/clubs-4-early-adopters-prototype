...
export default function ClubMemberRemoveDialog(props: {
  ...
  async function submit(values: any) {
    try {
      ...
      // Remove member using club contract
      await (await clubContract.removeMember(values.wallet)).wait();
      // Display success toast and close dialog
      showToastSuccess("Member is removed");
      close();
    } catch (error: any) {
